...
Selamat datang di dokumentasi lengkap untuk project **LaporIn** - Platform Laporan Warga RT/RW dengan AI & Blockchain.
...
4. **[TECH_STACK.md](./TECH_STACK.md)**
   ...
   - Frontend stack (Next.js, React, TypeScript, Tailwind, MUI)
